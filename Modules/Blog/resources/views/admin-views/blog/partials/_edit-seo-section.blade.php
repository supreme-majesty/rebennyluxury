                    ...
                    <div class="bg-section rounded p-12 p-sm-20 h-100">
                        <div class="d-flex flex-column justify-content-between h-100 gap-20">
                            ...
                            <div class="upload-file">
                                <input type="file" name="meta_image" class="upload-file__input single_file_input" accept=".webp, .jpg, .jpeg, .png, .gif" value="" >
                            ...
                            <p class="fs-10 mb-0 text-center">{{ translate('JPG,_JPEG,_PNG,_Gif_Image_size_:_Max_2_MB') }} <span class="fw-medium">(325 x 100 px)</span></p>
                        </div>
                    </div>
                </div>
