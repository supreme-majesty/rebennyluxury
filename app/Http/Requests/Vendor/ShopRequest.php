...
class ShopRequest extends FormRequest
{
    ...
    public function rules():array
    {
        return [
            ...
            'bottomBanner' => 'mimes:png,jpg,jpeg|max:2048',
            'offerBanner' => 'mimes:png,jpg,jpeg|max:2048',
        ];
    }
    public function messages():array
    {
        return [
            'banner.mimes' => translate('banner_image_type_jpg,_jpeg,_or_png'),
            'banner.max' => translate('banner_maximum_size_') . MAXIMUM_IMAGE_UPLOAD_SIZE,
            'image.mimes' => translate('image_type_jpg,_jpeg_or_png'),
            'image.max' => translate('image_maximum_size_') . MAXIMUM_IMAGE_UPLOAD_SIZE,
            'bottomBanner.mimes' => translate('bottom_banner_type_jpg,_jpeg_or_png'),
