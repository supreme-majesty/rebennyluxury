...
class VendorAddRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bottom_banner'     => 'mimes:jpg,jpeg,png|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'image.max' => translate('vendor_image_may_not_be_greater_than_2MB'),
            ...
            'logo.mimes' => translate('The_logo_type_must_be').'.jpg, .png, .jpeg',
            'logo.max' => translate('shop_logo_may_not_be_greater_than_2MB'),
            'banner.mimes' => translate('The_banner_type_must_be').'.jpg, .png, .jpeg',
            'banner.max' => translate('shop_cover_may_not_be_greater_than_2MB'),
            'bottom_banner.mimes' => translate('The_bottom_banner_type_must_be').'.jpg, .png, .jpeg',
            'bottom_banner.max' => translate('bottom_banner_may_not_be_greater_than_2MB'),
