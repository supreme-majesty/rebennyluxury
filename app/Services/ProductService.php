...
class ProductService
{
    ...
    public function getDigitalVariationCombinationView(object $request, ?object $product = null): string
    {
        ...
        return view('admin-views.product.partials._digital-variation-combination', compact('generateCombination', 'unitPrice', 'productName', 'digitalProductType', 'request'))->render();
    }
