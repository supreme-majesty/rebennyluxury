                            ...
                            <div class="mt-4">
                                @if($orders->count() > 0)
                                    <div class="table-responsive d-none d-sm-block">
                                        <table class="table my_orderlist__table table-borderless align-middle table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th class="bg-body ">{{translate('amount')}}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($order['order_status']=='failed' || $order['order_status']=='canceled')
                                                            <span class="badge rounded-1 fw-normal fs-12 bg-opacity-10 border-danger-1 text-bg-danger text-danger">
                                                        ...
                                                        @elseif($order['order_status']=='confirmed' || $order['order_status']=='processing' || $order['order_status']=='delivered')
                                                            <span class="badge rounded-1 fw-normal fs-12 bg-opacity-10 border-success-1 text-bg-success text-success">
                                                        ...
                                                        <div class="{{ $order['payment_status']=='unpaid' ? 'text-danger' : 'text-success' }} mt-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2 align-items-center">
                                                            <a href="{{ route('account-order-details', ['id'=>$order->id]) }}"
                                                               class="btn btn-outline-info btn-action" onclick="event.stopPropagation();">
                                                                <i class="bi bi-eye-fill"></i>
                                                            </a>
                                                            <a href="{{ route('generate-invoice', [$order->id]) }}"
                                                               class="btn btn-outline-success btn-action" onclick="event.stopPropagation();">
                    ...
                    <div class="modal-body rtl">
                        ...
                        <div class="text-center pb-3 pt-4 mt-xl-2">
                            ...
                            <div class="max-w-290 mx-auto">
                                <a href="{{ route('home') }}" class="btn min-h-45 w-100 py-2 fs-14 btn-primary text-capitalize px-4 rounded-10">
