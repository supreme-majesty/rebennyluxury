    ...
    <div class="card text-dark sticky-top-80">
        <div class="card-body px-sm-4 d-flex flex-column gap-2">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <div>{{ webCurrencyConverter($total_shipping_cost) }}</div>
            </div>
            ...
            @if ($referralAmount > 0)
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div>{{ '-' . webCurrencyConverter($referralAmount) }}</div>
                </div>
            @endif
            ...
            @if($systemTaxConfig['SystemTaxVat']['is_active'] && !$systemTaxConfig['is_included'])
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div>{{ webCurrencyConverter(amount: ($totalTax['item_tax'] + $totalTax['shipping_cost_tax'])) }}</div>
                </div>
            @endif
