...
<head>
    ...
    <style>
        :root {
            ...
            ;
            --bs-base-rgb:
                {{ getHexToRGBColorCode($web_config['primary_color']) }}
            ;
            --base-2:
...
<body class="toolbar-enabled">
    ...
    <script
        src="{{ dynamicAsset(path: 'public/assets/backend/libs/jquery-validate/jquery.validate.min.js') }}"></script>
    <script
    ...
    @endif
    <script
        src="{{ dynamicAsset(path: 'public/assets/backend/libs/google-recaptcha/google-recaptcha-init.js') }}"></script>
