        ...
        <div class="modal-dialog modal-lg  " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="mt-3 form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" method="post" action="{{route('ticket-submit')}}" id="open-ticket" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="d-flex flex-wrap upload_images_area">
                            ...
                            <label class="py-0 d-flex align-items-center m-0 cursor-pointer">
                                ...
                                <input type="file" id="attachmentfiles" class="attachmentfiles h-100 position-absolute w-100 " data-max-size="{{ getFileUploadMaxSize() }}" hidden multiple accept="{{getFileUploadFormats(skip: '.svg,.gif,.webp')}},image/*">
                            </label>
