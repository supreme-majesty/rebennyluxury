                            ...
                            <div class="d-flex flex-wrap align-items-baseline">
                                <div class="px-2 d-flex">
                                    <label class="m-0 cursor-pointer position-relative">
                                        ...
                                        <input type="file" id="f_p_v_up1" class="h-100 position-absolute w-100" data-max-size="{{ getFileUploadMaxSize() }}" hidden multiple accept="{{ getFileUploadFormats(skip: '.svg,.gif,.webp') }},image/*">
                                    </label>
                                </div>
