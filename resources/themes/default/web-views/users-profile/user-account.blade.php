                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                            <form class="mt-3 px-sm-2 pb-2 form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" action="{{route('user-update')}}" method="post"
                                  id="profile_form"
                                ...
                                <div class="profile--info mb-4">
                                    <div class="position-relative profile-img mb-3">
                                        ...
                                        <label class="change-profile-icon m-0">
                                            ...
                                            <input id="files" name="image" hidden type="file" accept="{{ getFileUploadFormats(skip: '.svg,.gif') }},image/*"  data-max-size="{{ getFileUploadMaxSize() }}">
                                        </label>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <input type="text" class="form-control" id="f_name" name="f_name"  data-required-msg="{{ translate('first_name_is_required') }}"
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <input class="form-control phone-input-with-country-picker" id="phone" type="tel" name="phone"
                                               value="{{ $customerDetail['phone'] }}" placeholder="{{ translate('enter_phone_number') }}" required
