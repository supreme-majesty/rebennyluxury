...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ "InsightifyTech Software Installation" }}</h2>
        <h6 class="fw-normal">
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="InsightifyTech Software Installation"
            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="db_host" class="form-control" name="DB_HOST" required
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="db_name" class="form-control" name="DB_DATABASE" required
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="db_user" class="form-control" name="DB_USERNAME" required
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" id="db_pass" min="8" class="form-control" name="DB_PASSWORD"
                                            required placeholder="Ex: password" autocomplete="off">
