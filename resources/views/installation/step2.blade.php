...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ "InsightyTech Software Installation" }}</h2>
        <h6 class="fw-normal">
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="InsightyTech Software Installation"
