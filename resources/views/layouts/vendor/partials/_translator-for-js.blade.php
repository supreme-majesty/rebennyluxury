...
<span id="get-confirm-and-cancel-button-text-for-blog-category-delete" data-sure ="{{translate('are_you_sure_to_delete_this_category').'?'}}"
      ...
      data-confirm="{{translate('yes_delete')}}" data-cancel="{{translate('not_now')}}" data-cancel-color="#F4F4F4" data-confirm-color="#FF6767"></span>
...
<span id="get-email-and-otp-verification-info-message" data-info="{{translate('both_Phone_&_Email_verification_can_not_be_active_at_a_time')}}"></span>
...
<span id="get-minimum-amount-message" data-error="{{ translate('minimum_amount_can_not_be_greater_than_maximum_amount').'!'}}"></span>
<span id="get-file-upload-field-required-message" data-error="{{ translate('the_file_upload_field_is_required').'!'}}"></span>
<span id="select-minimum-one-box-message" data-warning="{{ translate('select_minimum_one_selection_box')}}"></span>
<span id="get-product-status-message" data-error="{{translate("status_updated_failed").'.'.' '.translate("product_must_be_approved").'.'}}"></span>
