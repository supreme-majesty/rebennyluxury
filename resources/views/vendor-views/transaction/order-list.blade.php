    ...
    <div class="content container-fluid ">
        ...
        <div class="store-report-content mb-2">
            ...
            <div class="center-chart-area">
                @include('layouts.vendor.partials._apexcharts',['title'=>'order_Statistics','statisticsValue'=>$chartVal,'label'=>array_keys($order_transaction_chart['order_amount']),'statisticsTitle'=>'total_order_amount'])
            </div>
