...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{route('vendor.delivery-man.index')}}" method="post" enctype="multipart/form-data" id="add-delivery-man-form" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation" novalidate="novalidate">
            @csrf
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image" id="customFileEg1" class="title-color custom-file-input"
                                           ...
                                           data-required-msg="{{ translate('deliveryman_image_is_required') }}"
                                           accept="{{getFileUploadFormats(skip: '.svg')}},image/*" required>
