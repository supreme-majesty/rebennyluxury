                    ...
                    <form action="{{ url()->current() }}" method="GET">
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" name="searchValue" class="form-control"
                                   placeholder="{{ translate('search_by_Product') }}"
            ...
            <form action="{{ url()->current() }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="d-flex align-items-end h-100">
                            <div class="mb-2 form-group w-100">
                                <a id="filter" href="{{ route('vendor.reviews.index') }}" class="btn btn--primary btn-block ">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex align-items-end h-100">
                            <div class="mb-2 form-group w-100">
                                <a type="button" class="btn btn-outline--primary w-100" href="{{ route('vendor.reviews.export', ['product_id' => $product_id, 'customer_id' => $customer_id, 'status' => $status, 'from' => $from, 'to' => $to, 'searchValue'=>$searchValue]) }}">
