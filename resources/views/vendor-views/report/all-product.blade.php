    ...
    <div class="content container-fluid">
        ...
        <div class="store-report-content mb-2">
            ...
            <div class="center-chart-area">
                @include('layouts.vendor.partials._apexcharts',['title'=>'product_Statistics','statisticsValue'=>$chart_data['total_product'],'label'=>array_keys($chart_data['total_product']),'statisticsTitle'=>'total_product','getCurrency'=>false])
            </div>
        </div>
