    ...
    <div class="content container-fluid">
        ...
        <div class="store-report-content mb-2">
            ...
            <div class="center-chart-area">
                @include('layouts.vendor.partials._apexcharts',['title'=>'order_Statistics','statisticsValue'=>$chartVal,'label'=>array_keys($chart_data['order_amount']),'statisticsTitle'=>'total_settled_amount'])
            </div>
                ...
                <table id="datatable"
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order->total_tax_amount ?? $order->details_sum_tax), currencyCode: getCurrencyCode()) }}</td>
