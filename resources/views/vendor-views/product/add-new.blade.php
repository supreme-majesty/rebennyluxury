...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start form-advance-validation form-advance-file-validation" action="{{ route('vendor.products.add') }}"
                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form {{ getLanguageCode($lang) }}-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <div class="outline-wrapper" id="editor-container-{{ getLanguageCode($lang) }}">
                                    <textarea name="description[]" id="description-{{ getLanguageCode($lang) }}" class="summernote {{ $lang == $defaultLanguage ? 'product-description-default-language' : '' }}" data-required-msg="{{ translate('Description_field_is_required') }}" required>{{ old('details') }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="card rest-part bg-animate">
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3" id="">
                                    <div class="form-group">
                                        <div class="d-flex gap-2 mb-2">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="">
                                    <div class="form-group">
                                        <div class="d-flex gap-2">
                                            <label class="title-color">
            ...
            <div class="variation_wrapper mt-3 physical_product_show">
                <div class="outline-wrapper">
                    <div class="card rest-part physical_product_show bg-animate">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="d-flex gap-2">
                                <i class="tio-user-big"></i>
        ...
        <div class="floating-ai-button">
            {{-- <button type="button" class="btn btn-primary btn-lg rounded-circle shadow-lg"
                    data-toggle="modal" data-target="#aiAssistantModal" data-action="main"
                    title="AI Assistant">
                <i class="fi fi-rr-user-robot robot-icon-add-custom-font-size"></i>
            </button> --}}
