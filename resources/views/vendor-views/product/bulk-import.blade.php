    ...
    <div class="content container-fluid">
        ...
        <div class="row text-start">
            ...
            <div class="col-md-12 mt-2">
                <form class="product-form form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" action="{{ route('vendor.products.bulk-import') }}" method="POST"
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="uploadDnD">
                                            <div class="form-group inputDnD input_image input_image_edit" data-title="{{translate('drag_&_drop_file_or_browse_file')}}">
                                                <input type="file" name="products_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area" data-max-size="{{ getFileUploadMaxSize(type: 'file') }}" id="inputFile" data-required-msg="{{ translate('Products file is required') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
