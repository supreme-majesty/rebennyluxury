            ...
            <table class="border bs-0" style="border-radius:12px;">
                @if ($order->order_type == 'default_type')
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right" style="padding:23px 16px; padding-inline-start:0">
                            <div class="mb-1 fs-10">
                            ...
                            @foreach($order->details as $key=>$details)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-nowrap">
                                        <div class="fs-10 text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $details['price']), currencyCode: getCurrencyCode()) }}</div>
                                    </td>
                                    <td class="text-right text-nowrap">
                                    ...
                                    <table>
                                        ...
                                        @if($orderTotalPriceSummary['referAndEarnDiscount'] > 0)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    - {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['referAndEarnDiscount']), currencyCode: getCurrencyCode()) }}</td>
                                            </tr>
                                        @endif
                                        <tr>
