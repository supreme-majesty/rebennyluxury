...
@section('content')
    <div class="content container-fluid">
                                    ...
                                    <div class="card card-body p-3 shadow-popup">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <a class="text-primary fw-medium text-underline text-capitalize text-end"
                                                id="add_new_customer" type="button" data-toggle="modal" href="#add-customer"
                                            ...
                                            <div class="bg-section p-5 rounded custom_dropdown_empty">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    {{ translate('No_customer_found') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <span id="route-vendor-pos-change-cart-editable"
            data-url="{{ route('vendor.pos.change-cart') . '/?cart_id=:value' }}"></span>
        ...
        <span id="message-please-choose-all-the-options"
            data-text="{{ translate('please_choose_all_the_options') }}"></span>
        ...
        <span id="message-sorry-product-is-out-of-stock"
            data-text="{{ translate('sorry_product_is_out_of_stock') }}"></span>
        ...
        <span id="message-less-than-total-amount"
            data-text="{{ translate('paid_amount_is_less_than_total_amount') }}"></span>
