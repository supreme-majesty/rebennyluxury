                                    ...
                                    <div class="d-flex flex-column gap-20">
                                        ...
                                        <div class="upload-file">
                                            <input type="file" name="image"
                                                ...
                                                accept="{{getFileUploadFormats(skip: '.svg,.gif,.webp')}},image/*" {{ empty(getStorageImages(path: $shop->image_full_url, type: 'backend-basic')) ? 'required' : '' }}>
                                    ...
                                    <div class="d-flex flex-column gap-20">
                                        ...
                                        <div class="upload-file">
                                            <input type="file" name="banner"  data-max-size="{{ getFileUploadMaxSize() }}"
                                                ...
                                                accept="{{getFileUploadFormats(skip: '.svg,.gif,.webp')}},image/*" {{ empty(getStorageImages(path: $shop->banner_full_url, type: 'backend-banner')) ? 'required' : '' }}>
                                        ...
                                        <div class="d-flex flex-column gap-20">
                                            ...
                                            <div class="upload-file">
                                                <input type="file" name="bottom_banner"  data-max-size="{{ getFileUploadMaxSize() }}"
                                                    class="upload-file__input single_file_input"
                                                    accept="{{getFileUploadFormats(skip: '.svg,.gif,.webp')}},image/*" {{ empty(getStorageImages(path: $shop->bottom_banner_full_url, type: 'backend-banner')) ? 'required' : '' }}>
                                                <label class="upload-file__wrapper w-325 mb-0">
                                                    <div class="upload-file-textbox text-center ">
                                                        <img width="34" height="34" class="svg img-fluid"
                                                            src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/svg/image-upload.svg') }}"
                                        ...
                                        <div class="d-flex flex-column gap-20">
                                            ...
                                            <div class="upload-file">
                                                <input type="file" name="offer_banner"
                                                    class="upload-file__input single_file_input"
                                                    accept="{{getFileUploadFormats(skip: '.svg,.gif')}}" {{ empty(getStorageImages(path: $shop->offer_banner_full_url, type: 'backend-banner')) ? 'required' : '' }}>
                                                <label class="upload-file__wrapper w-325 mb-0">
                                                    <div class="upload-file-textbox text-center ">
                                                        <img width="34" height="34" class="svg img-fluid"
                                                            src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/svg/image-upload.svg') }}"
