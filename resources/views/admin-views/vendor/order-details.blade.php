                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h6 class="text-dark">{{substr($detail->productAllStatus['name'],0,30)}}{{strlen($detail->productAllStatus['name'])>10?'...':''}}</h6>
                                            ...
                                            <div class="media m-1 gap-3">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a href="tel:{{ isset($order->deliveryMan) ? $order->deliveryMan->phone : ''}}"
                                                       class="fs-12 text-dark">{{ isset($order->deliveryMan) ? $order->deliveryMan->phone :''}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                        ...
                        <div class="card-body">
                            ...
                            <div class="media flex-wrap gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    <span
                                        class="text-dark"><strong>{{$order->customer['f_name'].' '.$order->customer['l_name']}} </strong></span>
                                    <span
                        ...
                        @if($shipping_address)
                            <div class="card-body">
                                <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                    ...
                                    <button class="btn btn-outline-primary btn-sm icon-btn" title="Edit"
                        ...
                        <div class="media">
                            @if($order->seller_is == 'admin')
                                ...
                                <div class="media-body d-flex flex-column gap-2">
                                    <h5>{{ $company_name }}</h5>
                                    <span class="text-dark"><strong>{{ $total_delivered }}</strong> {{translate('orders_Served')}}</span>
                                </div>
                            @else
