                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                ...
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    ...
                                    <li>{{'{time}'.' : '.translate('the_expected_delivery_date_or_time').'.'}}</li>
                                    <li>{{'{productList}'.' : '.translate('the_list_of_ordered_products').'.'}}</li>
                                    <li>{{'{totalQty}'.' / '.'{qty}'.' : '.translate('the_total_quantity_of_items_in_the_order').'.'}}</li>
                                    <li>{{'{paymentStatus}'.' : '.translate('the_payment_status_of_the_order').'.'}}</li>
                                    <li>{{'{orderStatus}'.' : '.translate('the_order_status').'.'}}</li>
                                    <li>{{'{customerMessage}'.' : '.translate('the_customer_message_or_order_note').'.'}}</li>
                                    <li>{{'{deliveryManMessage}'.' : '.translate('the_delivery_man_message_or_note').'.'}}</li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide px-3">
