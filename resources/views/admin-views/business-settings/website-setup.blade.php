                                                        ...
                                                        <div class="d-flex flex-column gap-20">
                                                            ...
                                                            <div class="upload-file">
                                                                <input type="file" name="company_web_logo" class="upload-file__input single_file_input" id="imageInput" value="{{ getStorageImages(path:$businessSetting['web_logo'],type: 'backend-placeholder') ?? '' }}"
                                                                       accept=".webp, .jpg, .jpeg, .png, .gif" {{ !empty($businessSetting['web_logo']) ? '' : 'required' }} data-required-msg="{{ translate('website_header_logo_field_is_required') }}" data-max-size="{{ getFileUploadMaxSize() }}">
                                                                <label
                                                            ...
                                                            <p class="fs-10 mb-0 text-center text-capitalize">
                                                                {{ translate('jpg,_jpeg,_png,_gif_image_size') }} : {{ translate('Max_'). getFileUploadMaxSize() . translate('_MB') }} <span class="fw-medium">{{ "(325 x 100 px)" }}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex flex-column gap-20">
                                                            ...
                                                            <div class="upload-file">
                                                                ...
                                                                accept=".webp, .jpg, .jpeg, .png, .gif" data-required-msg="{{ translate('website_header_logo_mobile_view_field_is_required') }}" data-max-size="{{ getFileUploadMaxSize() }}">
                                                            ...
                                                            <p class="fs-10 mb-0 text-center">{{ translate('jpg,_jpeg,_png,_gif_image_size') }} : {{ translate('Max_').getFileUploadMaxSize(). translate('_MB') }}<span class="fw-medium">({{ translate('Ratio') }} {{ "1:1" }})</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="d-flex flex-column gap-20">
                                                            ...
                                                            <div class="upload-file">
                                                                <input type="file" name="company_footer_logo" class="upload-file__input single_file_input"
                                                                       accept=".webp, .jpg, .jpeg, .png, .gif"  value="{{ getStorageImages(path:$businessSetting['footer_logo'],type: 'backend-placeholder') ?? '' }}" {{ !empty($businessSetting['footer_logo']) ? '' : 'required' }} data-max-size="{{ getFileUploadMaxSize() }}" data-required-msg="{{ translate('website_footer_logo_is_required') }}">
                                                                <label
                                                                    class="upload-file__wrapper w-325">
                                                        ...
                                                        <div class="d-flex flex-column gap-20">
                                                            ...
                                                            <div class="upload-file">
                                                                <input type="file" name="company_fav_icon" class="upload-file__input single_file_input" value="{{ getStorageImages(path:$businessSetting['fav_icon'],type: 'backend-placeholder') ?? '' }}" {{ !empty($businessSetting['fav_icon']) ? '' : 'required' }}
                                                                       accept=".webp, .jpg, .jpeg, .png, .gif" data-required-msg="{{ translate('website_favicon_is_required') }}" data-max-size="{{ getFileUploadMaxSize() }}">
                                                                <label
                                                                    class="upload-file__wrapper">
                                                        ...
                                                        <div class="d-flex flex-column gap-20">
                                                            ...
                                                            <div class="upload-file">
                                                                <input type="file" name="loader_gif" class="upload-file__input single_file_input" value="{{ getStorageImages(path:$businessSetting['loader_gif'],type: 'backend-placeholder') ?? '' }}" {{ !empty($businessSetting['loader_gif']) ? '' : 'required' }}
                                                                       accept=".webp, .jpg, .jpeg, .png, .gif" data-required-msg="{{ translate('website_loader_gif_is_required') }}" data-max-size="{{ getFileUploadMaxSize() }}">
                                                                <label
                                                                    class="upload-file__wrapper">
