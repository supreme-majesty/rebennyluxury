                                        ...
                                        <div class="d-flex flex-column gap-30 w-100">
                                            ...
                                            <div class="upload-file">
                                                <input type="file" name="image" class="upload-file__input single_file_input"
                                                       id="banner" accept="{{getFileUploadFormats(skip: '.svg')}},image/*" required  data-max-size="{{ getFileUploadMaxSize() }}"
                                            ...
                                            <p class="fs-12 text-center max-w-360 m-auto">
                                                {{translate("only_".getFileUploadFormats(skip: '.svg', asMessage: 'true'))}}  {{ translate('allowed_max_size_2_mb') }}
                                            </p>
                                            <p class="fs-12 text-center max-w-360 m-auto">
