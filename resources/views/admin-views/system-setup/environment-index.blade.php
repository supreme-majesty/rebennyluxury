        ...
        <div class="d-flex flex-column gap-3 gap-sm-20">
            <div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded">
                ...
                <ul class="m-0 ps-20 d-flex flex-column gap-1 text-body">
                    ...
                    <li>{{ translate('when_you_on_debug_mode_to_check_your_system_issues_&_error_then_you_can_live_or_dev_mode') }}.
                    </li>
                </ul>
            </div>
            ...
            <form action="{{route('admin.system-setup.environment-setup') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3 mb-sm-20">
                        ...
                        <div class="p-12 p-sm-20 bg-section rounded">
                            <div class="row g-4">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ env('APP_URL') }}" name="app_url" class="form-control"
                                            placeholder="{{ translate('ex') . ':' . 'http://localhost'}}" required readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('DB_connection') }}</label>
                                        <input type="text"
                                            value="{{ env('APP_MODE') != 'demo' ? env('DB_CONNECTION') : '---' }}"
                                            name="db_connection" class="form-control"
                                            placeholder="{{ translate('ex') . ':' . 'mysql' }}" required readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ env('APP_MODE') != 'demo' ? env('DB_PORT') : '---' }}"
                                            ...
                                            placeholder="{{ translate('ex') . ':' . '3306' }}" required readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('DB_database') }}</label>
                                        <input type="text"
                                            value="{{ env('APP_MODE') != 'demo' ? env('DB_DATABASE') : '---' }}"
                                            name="db_database" class="form-control"
                                            placeholder="{{ translate('ex') . ':' . 'demo_db'}} " required readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('DB_username') }}</label>
                                        <input type="text"
                                            value="{{ env('APP_MODE') != 'demo' ? env('DB_USERNAME') : '---' }}"
                                            name="db_username" class="form-control"
                                            placeholder="{{ translate('ex') . ':' . translate('root')  }}" required readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('DB_password') }}</label>
                                        <input type="password"
                                            value="{{ env('APP_MODE') != 'demo' ? env('DB_PASSWORD') : '---' }}"
                                            name="db_password" class="form-control"
                                            placeholder="{{ translate('ex') . ':' . translate('password') }}" readonly
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('buyer_username') }}</label>
                                        <input type="text" value="{{ env('BUYER_USERNAME') }}" class="form-control"
                                            placeholder="{{ translate('rebennyluxury-admin-demo-jhisdfhisufjifjfijqw5467') }}"
                                            readonly data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                            data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label text-capitalize"
                                            for="">{{ translate('purchase_code') }}</label>
                                        <div class="input-icons">
                                            <input type="password" value="{{ env('PURCHASE_CODE') }}" class="form-control"
                                                id="purchase_code" placeholder="{{ translate('00000000000000') }}" readonly
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                aria-label="{{ translate('this_field_is_read_only_mode.') }}"
                                                data-bs-title="{{ translate('this_field_is_read_only_mode.') }}">
                                        </div>
                ...
                <div class="row d-none">
                        ...
                        <div class="card">
                            <div class="border-bottom px-4 py-3">
                                <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                    <img width="20" src="{{dynamicAsset(path: 'public/assets/back-end/img/environment.png') }}"
                                        alt="">
                                    {{ translate('Force_HTTPS') }}
                                </h5>
                            </div>
                            <div class="card-body">
                                <form action="{{route('admin.system-setup.environment-https-setup') }}" method="post"
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.system-setup.optimize-system') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.system-setup.install-passport') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="">{{ translate('Install') }}</label>
                                        <select name="status" class="custom-select" data-placeholder="Select from dropdown">
                                            <option></option>
