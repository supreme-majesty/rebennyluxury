<div class="d-flex flex-column gap-20 bg-section p-12 p-sm-20 rounded">
    ...
    <div class="upload-file">
        <input type="file" name="shop_banner" class="upload-file__input single_file_input" data-required-msg="{{ translate('shop_cover_field_is_required')}}"  data-max-size="{{ getFileUploadMaxSize() }}"
            accept=".webp, .jpg, .jpeg, .png, .gif"  {{ getInHouseShopConfig(key: 'banner_full_url') ? '' : 'required' }}>
