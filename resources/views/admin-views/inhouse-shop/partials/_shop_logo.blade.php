<div class="d-flex flex-column gap-20 bg-section p-12 p-sm-20 rounded">
    ...
    <div class="upload-file">
        <input type="file" name="image" class="upload-file__input single_file_input" data-required-msg="{{ translate('shop_logo_field_is_required')}}"  data-max-size="{{ getFileUploadMaxSize() }}"
            accept=".webp, .jpg, .jpeg, .png, .gif"   {{ getInHouseShopConfig(key: 'image_full_url') ? '' : 'required' }}>
        <label class="upload-file__wrapper ratio-1-1">
            ...
            <img class="upload-file-img" loading="lazy"
                ...
                data-default-src="{{ getStorageImages(path: getInHouseShopConfig(key: 'image_full_url'), type: 'shop') }}"
                alt="">
        </label>
        <div class="overlay">
