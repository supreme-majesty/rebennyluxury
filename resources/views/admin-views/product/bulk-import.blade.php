                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="uploadDnD">
                                                ...
                                                <input type="file" name="products_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area"  data-max-size="{{ getFileUploadMaxSize(type: 'file') }}"  data-required-msg="{{ translate('file_field_is_required') }}" id="inputFile" required>
                                            </div>
                                        </div>
