...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.customer.wallet.bonus-setup-update') }}" id="add-wallet-bonus-setup" method="post" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation" novalidate="novalidate">
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="bonus_amount"
                                    ...
                                    {{translate('bonus_amount')}}(<span id="bonus-title-percent">{{translate('%')}}<span class="text-danger">*</span> </span>)
                                </label>
                                <input type="number" name="bonus_amount" min="0" class="form-control" id="bonus-title-percent"
                                       ...
                                       data-required-msg="{{translate('bonus_amount_field_is_required')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date_time" id="start-date-time" class="form-control"
                                       data-required-msg="{{translate('start_date_field_is_required')}}"
