...
@section('content')
    <div class="content container-fluid">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3" src="{{dynamicAsset(path: 'public/assets/back-end/img/wallet-bonus.png')}}" loading="lazy" alt="">
                                <h3 class="lh-base">{{ translate('wallet_bonus_is_only_applicable_when_a_customer_wants_to_add_fund_to_wallet_via_outside_payment_gateway').'!' }}
                                </h3>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.customer.wallet.bonus-setup') }}" id="add-wallet-bonus-setup" method="post" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation" novalidate="novalidate">
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="bonus_title"
                                       class="mb-2 text-capitalize d-flex">{{translate('bonus_title')}} <span class="text-danger">*</span> </label>
                                <input type="text" name="title" class="form-control" id="bonus_title"
                                       data-required-msg="{{translate('bonus_title_field_is_required')}}"
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                    <select name="bonus_type" id="bonus-type" class="form-select"  data-required-msg="{{translate('bonus_type_field_is_required')}}" required>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="min_add_money_amount"
                                    ...
                                    ({{ getCurrencySymbol(currencyCode: getCurrencyCode(type: 'default')) }}) <span class="text-danger">*</span> </label>
                                <input type="number" name="min_add_money_amount" min="0" class="form-control"
                                       ...
                                       data-required-msg="{{translate('min_add_money_amount_field_is_required')}}"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="start-date-time"
                                       class="mb-2 text-capitalize d-flex">{{translate('Start_Date')}} <span class="text-danger">*</span> </label>
                                <input type="date" name="start_date_time" id="start-date-time" class="form-control"  data-required-msg="{{translate('start_date_field_is_required')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="end-date-time"
                                       class="mb-2 text-capitalize d-flex">{{translate('End_Date')}} <span class="text-danger">*</span></label>
                                <input type="date" name="end_date_time" id="end-date-time" class="form-control" data-required-msg="{{translate('end_date_field_is_required')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end">
                                ...
                                <button type="button" class="btn btn-primary form-submit" data-form-id="add-wallet-bonus-setup">{{translate('submit')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card-body">
                <div class="row align-items-center mb-4">
                    <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                        <h3 class="mb-0 d-flex align-items-center gap-10">
                            {{translate('wallet_Bonus_Table')}}
                            <span class="badge badge-info text-bg-info">{{ $data->total() }}</span>
                        </h3>
                    </div>
                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        @foreach ($data as $key=>$item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.customer.wallet.bonus-setup-status')}}" method="post" id="bonus-setup-{{ $item->id }}-form" class="no-reload-form">
                                        @csrf
                                        <input name="id" value="{{$item['id']}}" hidden>
                                        <label class="switcher mx-auto" for="bonus-setup-{{ $item->id }}">
                                            <input
                                                class="switcher_input custom-modal-plugin"
                                                type="checkbox" value="1" name="status"
                                                id="bonus-setup-{{ $item->id }}"
                                                {{ ($item->is_active == 1 ? 'checked':'')}}
                                                data-modal-type="input-change-form"
                                                data-modal-form="#bonus-setup-{{ $item->id }}-form"
                                                data-on-image=""
                                                data-off-image=""
                                ...
                                <td>
                                    <div class="d-flex gap-10 justify-content-center">
                                        <a title="{{translate('edit')}}"
                                           type="button" class="btn btn-outline-primary icon-btn edit"
