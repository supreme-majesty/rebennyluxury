...
@section('content')
        ...
        <div class="row mt-2">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group d-flex justify-content-end">
                                    <select name="category" id="category"
                                        class="form-select custom-select w-100 action-category-filter"
                            ...
                            <div class="col-sm-6">
                                <form action="" method="get">
                                    <div class="input-group flex-grow-1 position-relative">
                                        <input id="search" autocomplete="off" type="text" value="{{ $searchValue }}"
                                            name="searchValue" class="form-control search-bar-input"
                                            placeholder="{{ translate('search_by_name_or_sku') }}" aria-label="Search here">
                    ...
                    <div class="card-body pt-2 pb-80 overflow-hidden" id="items">
                        ...
                        @else
                            <div class="p-4 bg-chat rounded text-center">
                                <div class="py-5">
                                    <img src="http://localhost/Backend-rebennyluxury-eCommerce-CMS/public/assets/back-end/img/empty-product.png"
                                        width="64" alt="">
            ...
            <div class="col-lg-5">
                <div class="card billing-section-wrap overflow-hidden">
                    <div
                        class="card-header border-0 bg-section2 p-2 d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <h3 class="px-3 m-0">{{ translate('Billing_Section') }}</h3>
                        <button type="button"
                            class="btn text-primary bg-white border-0 d-flex align-items-center justify-content-center gap-2 action-view-all-hold-orders"
                            ...
                            <span class="total_hold_orders btn bg-danger text-white fw-medium h-25px p-1 btn-circle"
                                style="--size: 25px;">
                                {{ $totalHoldOrder}}
                            </span>
                        </button>
                    ...
                    <div class="card-body d-flex flex-column gap-20 overflow-y-auto">
                        <div>
                            ...
                            <div class="position-relative custom_dropdown_wrapper">
                                <div
                                    class="form-control custom_dropdown_toggle d-flex gap-2 justify-content-between align-items-center min-h-40 h-auto overflow-wrap-anywhere">
                                ...
                                <div class="custom_dropdown_menu">
                                    <div class="card card-body p-3 shadow-popup">
                                        <div class="d-flex flex-column gap-2">
                                            <div
                                                class="position-relative d-flex form-control align-items-center gap-2 bg-section">
                                                <i class="fi fi-rr-search fs-16"></i>
                                                <input type="search"
                                                    class="w-100 border-0 outline-none bg-transparent custom_dropdown_search"
                                                    placeholder="{{ translate('Search_name_or_phone_number') }}">
                                            </div>
                                            <a class="text-primary fw-medium text-underline text-capitalize text-end"
                                                id="add_new_customer" data-bs-toggle="modal" href="#add-customer"
                                                title="{{ translate('add_new_customer') }}">
                                                + {{ translate('add_New_Customer') }}
                                            </a>
                                            <div class="custom_dropdown_list">
                                                <div class="custom_dropdown_item action-customer-change fs-12 fw-medium"
                                                    data-id="0">
    ...
    <button class="d-none" id="hold-orders-modal-btn" type="button" data-bs-toggle="modal"
        data-bs-target="#hold-orders-modal">
    </button>
    ...
    <span id="message-you-want-to-create-new-order"
        data-text="{{ translate('Want_to_create_new_order_for_another_customer') }}"></span>
    ...
    <span id="message-please-add-product-in-cart-before-applying-discount"
        data-text="{{ translate('please_add_product_to_cart_before_applying_discount') }}"></span>
    <span id="message-please-add-product-in-cart-before-applying-coupon"
        data-text="{{ translate('please_add_product_to_cart_before_applying_coupon') }}"></span>
    ...
    <span id="message-product-quantity-cannot-be-less-then-one"
        data-text="{{ translate('product_quantity_can_not_be_less_then_one') }}"></span>
