...
<form action="{{route('admin.pos.place-order') }}" method="post" id='order-place'>
    ...
    <div class="d-flex flex-column gap-20">
        <div class="">
            <button class="btn-collapse d-flex gap-3 align-items-center justify-content-between bg-section2 rounded-top rounded-on-collapse text-dark border-0 p-3 w-100 {{ $isExpanded ? '' : 'collapsed' }}" type="button"
                    data-bs-toggle="collapse" data-bs-target="#collapsecCartList"   aria-expanded="{{ $isExpanded ? 'true' : 'false' }}">
            ...
            <div class="">
                <dl>
                    ...
                    <div class="d-flex gap-2 justify-content-between px-3 py-2">
                        ...
                        <dd>
                            <button id="coupon_discount" class="btn btn-sm p-0 border-0 d-flex gap-3 text-primary fw-normal shadow-none" type="button" data-bs-toggle="modal" data-bs-target="#add-coupon-discount">
                    ...
                    <div class="d-flex gap-2 justify-content-between px-3 py-2">
                        ...
                        <dd>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <a href="#" class="text-danger lh-1" id="pos-extra-discount-remove-admin">
                                    <i class="fi fi-rr-trash"></i>
                                </a>
                                @endif
                                <button id="extra_discount" class="btn btn-sm p-0 border-0 d-flex gap-3 text-primary fw-normal shadow-none" type="button" data-bs-toggle="modal" data-bs-target="#add-discount">
                                    <i class="fi fi-rr-pencil"></i>
                                    <span class="text-underline">
