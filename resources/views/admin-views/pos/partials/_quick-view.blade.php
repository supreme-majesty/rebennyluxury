                        ...
                        <div class="variant-change">
                            <div class="position-relative mb-4">
                                @if (count(json_decode($product->colors)) > 0)
                                    <div class="d-flex gap-3 align-items-center">
                                        <span class="text-9B9B9B flex-shrink-0">{{ translate('color') }}</span>
                            ...
                            @foreach (json_decode($product->choice_options) as $key => $choice)
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <div class="my-2 w-43px">
                                        <span class="text-9B9B9B flex-shrink-0">{{ ucfirst($choice->title) }}</span>
                                    </div>
                            ...
                            @if (
                                ...
                                @foreach ($product['digital_product_extensions'] as $extensionKey => $extensionGroup)
                                    <div class="d-flex gap-3 align-items-center mb-3">
                                        <div class="my-2">
                                            <span class="text-9B9B9B flex-shrink-0">{{ translate($extensionKey) }}</span>
                                        </div>
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                @foreach ($extensionGroup as $index => $extension)
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="text-nowrap max-w-180 line-1">{{ $extension }}</span>
                                                    </label>
                                                    @php($extensionIndex++)
                                                @endforeach
                                            </div>
